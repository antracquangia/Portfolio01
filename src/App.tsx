import { Github, Mail, Linkedin, Terminal, User, Briefcase, Cpu, GraduationCap } from 'lucide-react';
...
const projects = [
  {
    ...
    updateProcess: [
      'Refactored the dashboard charts to use memoization, improving rendering performance by 30%.',
      'Added OAuth2 support for seamless Google and Facebook authentication.',
      'Migrated complex data aggregation logic to background workers to reduce API latency.'
    ],
    userComments: [
      'This app completely changed my life. Tracking my spending is suddenly so effortless!',
      'Great user interface, and the interactive charts provide such clear insights.'
    ],
    star: {
  ...
  },
  {
    ...
    updateProcess: [
      'Expanded support to include live data for multiple global fiat currencies.',
      'Implemented a Redis caching layer to drastically reduce third-party API limits.',
      'Revamped the Telegram bot messages with inline keyboards for a better user experience.'
    ],
    userComments: [
      'I have been able to make better trading decisions thanks to the real-time notifications!',
      'The bot is incredibly reliable, and the setup was seamless.'
    ],
    star: {
  ...
  },
  {
    ...
    updateProcess: [
      'Scaled the Redis caching architecture to handle over 10,000 concurrent requests smoothly.',
      'Optimized the Base62 encoding algorithm to generate significantly shorter URLs.',
      'Introduced a new feature enabling users to create custom aliased, branded short links.'
    ],
    userComments: [
      'It just works perfectly, and the click analytics dashboard is incredibly detailed.',
      'Our marketing team uses this daily to track our campaign performances reliably.'
    ],
    star: {
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-100 selection:bg-purple-500/30 selection:text-white relative overflow-hidden">
      ...
      <header className="max-w-5xl mx-auto px-6 py-20 md:py-32 relative z-10">
        ...
        <motion.img 
          ...
          className="absolute -bottom-24 md:-bottom-32 right-0 md:-right-10 w-24 md:w-48 opacity-80 drop-shadow-[0_0_30px_rgba(168,85,247,0.6)] pointer-events-none z-0 hidden md:block"
        />
        ...
        <div className="space-y-6 max-w-3xl relative z-10">
          ...
          <div className="flex items-center gap-4 pt-4">
            ...
            <a href="#" className="p-3 rounded-full bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 transition-colors text-zinc-300 hover:text-white">
      ...
      <main className="max-w-5xl mx-auto px-6 mt-24 md:mt-48 space-y-32 pb-32 relative z-10">
        ...
        <section className="space-y-8">
          ...
          <div className="bg-zinc-900/50 rounded-2xl border border-zinc-800 p-6 md:p-8 hover:border-zinc-700 hover:bg-zinc-900 transition-colors">
            <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
              <div>
                <h3 className="text-xl font-bold font-sans text-white">University of Information Technology</h3>
                <p className="text-zinc-400 mt-1">Studying</p>
              </div>
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20 text-sm font-medium whitespace-nowrap">
                2025 - 2026
              </div>
            </div>
          </div>
